...
export default class Dict extends React.Component {
        ...
        },
        {
            ...
            render: (text, record) => (
                <div>
                    ...
                    <a href="javascript:" onClick={this.onChildClick(record)}>字典项</a>
                    <Divider type="vertical"/>
                    <Popconfirm
    ...
    onChildClick = (record) => () => {
        ...
        this.props.history.push(parentPath + "/"+record.code);
    };
        ...
        return (
            <div className={"fill-parent"}>
                <EditDialog
                    ref={this._createRef}
                    title={"新增用户"}
                    loadData={dictTypeAPI.create}
                    onFinish={this.onCreateOrUpdateSuccess}
                />
                <EditDialog
                    ref={this._updateRef}
                    title={"新增用户"}
                    loadData={dictTypeAPI.update}
                    onFinish={this.onCreateOrUpdateSuccess}
                />
